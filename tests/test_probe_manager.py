...
class TestProbeManager:
    ...
    def test_send_probe_frame_success(self, probe_manager, mock_serial_manager):
        ...
        with patch('src.serial_file_transfer.core.probe_manager.FrameHandler.pack_frame') as mock_pack:
    ...
    def test_receive_probe_frame_success(self, probe_manager, mock_serial_manager):
        ...
        with patch('src.serial_file_transfer.core.probe_manager.FrameHandler.unpack_frame') as mock_unpack:
            mock_unpack.return_value = (ProbeCommand.PROBE_RESPONSE, 3, test_data, 0x0106)
            
            result = probe_manager._receive_probe_frame(ProbeCommand.PROBE_RESPONSE, 1.0)
    ...
    def test_send_probe_request_success(self, probe_manager, mock_serial_manager):
        ...
        with patch('src.serial_file_transfer.core.probe_structures.ProbeRequestData.create') as mock_create:
            # 创建固定的请求数据
